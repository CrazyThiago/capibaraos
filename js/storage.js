(function(){
  const SUPA_URL = "https://xfrnrkoqorvyanpobihm.supabase.co";
  const SUPA_KEY = "sb_publishable_mLmB_Fwo2IdZ8BG25wu4Og_2cAMU2PL";
  const REST = SUPA_URL + "/rest/v1/kv_store";
